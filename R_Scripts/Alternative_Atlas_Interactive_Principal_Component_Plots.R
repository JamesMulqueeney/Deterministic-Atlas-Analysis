...
# Alternative Atlas Comparison - Interactive Plots 
...
# Generate the plots 
A_Binturong_Atlas_Plot <- generate_plots(A_Binturong_Atlas, "A_Binturong_Atlas")
C_calvus_Atlas_Plot <- generate_plots(C_calvus_Atlas, "C_calvus_Atlas")
S_morckhoviensis_Atlas_Plot <- generate_plots(S_morckhoviensis_Atlas, "S_morckhoviensis_Atlas")

# Display plots
A_Binturong_Atlas_Plot
C_calvus_Atlas_Plot
S_morckhoviensis_Atlas_Plot
