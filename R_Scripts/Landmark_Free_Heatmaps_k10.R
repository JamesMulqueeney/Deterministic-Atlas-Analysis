...
# Kernel 10.0 - Landmark-free Heatmaps 
...
# Kernel 10.00mm (1782 Control Points)
...
# Load in the atlas 
atlas_10.0 <- read.ply(file.path(input_dir, "Binturong_DeterministicAtlas_Kernel_10.ply"))
...
shade3d(atlas_10.0, col="Red", specular=1, alpha = 0.5)

# Plot the warped mesh 
MD_10.1 <-  meshDist(mesh1, atlas_10.0, from = -150, to = 20)
...
# Plot the warped mesh 
MD_10.2 <-  meshDist(mesh2, atlas_10.0, from=-5, to = 5)
...
# Plot the warped mesh 
MD_10.3 <-  meshDist(mesh3, atlas_10.0, from=-80, to = 20)
...
# Plot the warped mesh 
MD_10.4 <-  meshDist(mesh4, atlas_10.0, from=-40, to = 15)
...
# Plot the warped mesh 
MD_10.5 <-  meshDist(mesh5, atlas_10.0, from=-40, to = 15)
...
# Plot the warped mesh 
MD_10.6 <-  meshDist(mesh6, atlas_10.0, from=-25, to = 15)
...
# Plot the warped mesh 
MD_10.7 <-  meshDist(mesh7, atlas_10.0, from=-40, to = 15)
...
# Plot the warped mesh 
MD_10.8 <-  meshDist(mesh8, atlas_10.0, from=-50, to = 10)
