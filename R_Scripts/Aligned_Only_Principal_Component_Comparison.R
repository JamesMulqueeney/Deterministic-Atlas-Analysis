...
g3 <- ggplot(Kernel_40.0, aes(x=PC1, y=PC2, shape=Mesh.Type,fill=Order,color=Status)) +
  ...
  scale_fill_manual(values = neworder) +
  labs(
    x = paste0("Principal Component 1 (57.59%)"),
    y = paste0("Principal Component 2 (13.59%)")
  )+
  theme_bw() +
  coord_fixed(ratio = 1) +
  theme(
...
g4 <- ggplot(Kernel_40.0, aes(x=PC3, y=PC4, shape=Mesh.Type,fill=Order,color=Status)) +
  ...
  scale_fill_manual(values = neworder) +
  labs(
    x = paste0("Principal Component 3 (7.84%)"),
    y = paste0("Principal Component 4 (4.74%)")
  )+
  theme_bw() +
  coord_fixed(ratio = 1) +
  theme(
...
g5 <- ggplot(Kernel_20.0, aes(x=PC1, y=PC2, shape=Mesh.Type,fill=Order,color=Status)) +
  ...
  scale_fill_manual(values = neworder) +
  labs(
    x = paste0("Principal Component 1 (42.40%)"),
    y = paste0("Principal Component 2 (10.03%)")
  )+
  theme_bw() +
  coord_fixed(ratio = 1) +
  theme(
...
g6 <- ggplot(Kernel_20.0, aes(x=PC3, y=PC4, shape=Mesh.Type,fill=Order,color=Status)) +
  ...
  scale_fill_manual(values = neworder) +
  labs(
    x = paste0("Principal Component 3 (6.86%)"),
    y = paste0("Principal Component 4 (5.72%)")
  )+
  theme_bw() +
  coord_fixed(ratio = 1) +
  theme(
...
g7 <- ggplot(Kernel_10.0, aes(x=PC1, y=PC2, shape=Mesh.Type,fill=Order,color=Status)) +
  ...
  scale_fill_manual(values = neworder) +
  labs(
    x = paste0("Principal Component 1 (26.68%)"),
    y = paste0("Principal Component 2 (7.77%)")
  )+
  theme_bw() +
  coord_fixed(ratio = 1) +
  theme(
...
g8 <- ggplot(Kernel_10.0, aes(x=PC3, y=PC4, shape=Mesh.Type,fill=Order,color=Status)) +
  ...
  scale_fill_manual(values = neworder) +
  labs(
    x = paste0("Principal Component 3 (5.40%)"),
    y = paste0("Principal Component 4 (4.97%)")
  )+
  theme_bw() +
  coord_fixed(ratio = 1) +
  theme(
