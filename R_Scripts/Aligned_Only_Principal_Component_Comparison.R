...
# Apply to the Aligned-only DAA results 

################################################################################

# Read in Aligned-only DAA results 
...
# Apply plot function 
p3 <- plot_pca(Kernel_40.0, "PC1", "PC2", 57.59, 13.59) # Kernel 40 - PC1-PC2
p4 <- plot_pca(Kernel_40.0, "PC3", "PC4", 7.84, 4.74) # Kernel 40 - PC3-PC4
p5 <- plot_pca(Kernel_20.0, "PC1", "PC2", 42.40, 10.03) # Kernel 20 - PC1-PC2
p6 <- plot_pca(Kernel_20.0, "PC3", "PC4", 6.86, 5.72) # Kernel 20 - PC3-PC4
p7 <- plot_pca(Kernel_10.0, "PC1", "PC2", 26.68, 7.77) # Kernel 10 - PC1-PC2
p8 <- plot_pca(Kernel_10.0, "PC3", "PC4", 5.40, 4.97) # Kernel 10 - PC3-PC4
