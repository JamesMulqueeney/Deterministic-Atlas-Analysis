...
# Kernel 20.0 - Landmark-free Heatmaps 
...
# Kernel 20.00mm (270 Control Points)
...
# Load in the atlas 
atlas_20.0 <- read.ply(file.path(input_dir, "Binturong_DeterministicAtlas_Kernel_20.ply"))
...
shade3d(atlas_20.0, col="Red", specular=1, alpha = 0.5)

# Plot the warped mesh 
MD_20.1 <-  meshDist(mesh1, atlas_20.0, from = -150, to = 20)
...
# Plot the warped mesh 
MD_20.2 <-  meshDist(mesh2, atlas_20.0, from = -5, to = 5)
...
# Plot the warped mesh 
MD_20.3 <-  meshDist(mesh3, atlas_20.0, from=-80, to = 20)
...
# Plot the warped mesh 
MD_20.4 <-  meshDist(mesh4, atlas_20.0, from=-40, to = 15)
...
# Plot the warped mesh 
MD_20.5 <-  meshDist(mesh5, atlas_20.0, from=-40, to = 15)
...
# Plot the warped mesh 
MD_20.6 <-  meshDist(mesh6, atlas_20.0, from=-40, to = 15)
...
# Plot the warped mesh 
MD_20.7 <-  meshDist(mesh7, atlas_20.0, from=-25, to = 15)
...
# Plot the warped mesh 
MD_20.8 <-  meshDist(mesh8, atlas_20.0, from=-50, to = 10)
